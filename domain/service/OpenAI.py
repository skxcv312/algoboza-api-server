...
# 관심사 추출
async def create_interest_keyword(interest_scores, max_search_keyword: int = 5):
    ...
    print_total_tokens("키워드", response)
...
# 영상 내용 요약
async def create_summary(description: str):
    ...
    try:
        ...
        print_total_tokens("요약", response)
